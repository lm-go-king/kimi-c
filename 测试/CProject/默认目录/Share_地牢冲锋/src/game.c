...
//        if((e.tfinger.x - lastX1) < 0.02 || (e.tfinger.y - lastY1) < 0.02){
...
//      }
      ...
      if((nowMilliSecond - lastMilliSecond) >= 200){
...
//      int keyValue = e.tfinger.keysym.sym;
